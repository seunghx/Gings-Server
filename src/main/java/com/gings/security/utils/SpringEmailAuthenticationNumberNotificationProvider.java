...
@Slf4j
@Component
public class SpringEmailAuthenticationNumberNotificationProvider implements AuthenticationNumberNotificationProvider {
    ...
    @Override
    public void sendAuthenticationNumber(String email, String temporaryPassword) {
    ...
    private String getMailMessage(String authNumber) {
        ...
        parameterMap.put(passwordKey, authNumber);
